...
/* Function  structure for function  `rc` */

/*!50003 DROP FUNCTION IF EXISTS `rc` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `rc`(departmentId varchar(50)) RETURNS varchar(50) CHARSET utf8
BEGIN
