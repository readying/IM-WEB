...
public class ResourceAuthorityImpl implements IResourceAuthorityService {
    ...
    @Override
    public List<Resource> queryResourceForAuthority(BaseModel baseModel) {
        return this.resourceAuthorityDao.queryAuthorityForRole(baseModel);
    }

    @Override
    public void insertResourceForAuthority(String id, List resourceIds) {
        this.resourceAuthorityDao.insertAuthorityForRole(id,resourceIds);
    }

    @Override
    public void removeResourceForAuthority(String id, List<String> resourceIds) {
        this.resourceAuthorityDao.removeResourceForAuthority(id,resourceIds);
    }
}
